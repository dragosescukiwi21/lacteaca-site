        ...
        >
          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 h-[700px]">
              ...
              <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-50/80 via-indigo-50/60 to-purple-50/80 backdrop-blur-sm border-[2px] border-gray-200/60 p-8 flex flex-col justify-between">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex-1 relative overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-50/80 via-teal-50/60 to-cyan-50/80 backdrop-blur-sm border-[2px] border-gray-200/60 p-8 flex flex-col justify-center">
                ...
                <div className="flex-1 relative overflow-hidden rounded-2xl bg-gradient-to-br from-orange-50/80 via-red-50/60 to-pink-50/80 backdrop-blur-sm border-[2px] border-gray-200/60 p-8 flex flex-col justify-center">
